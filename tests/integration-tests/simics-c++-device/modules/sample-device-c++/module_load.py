...
cli.new_info_command('sample_device_cxx_attribute_required', get_empty_info)
...
cli.new_info_command('sample_device_cxx_class_with_arg_init_class', get_empty_info)
...
cli.new_info_command('sample_device_cxx_notifier', get_empty_info)
...
cli.new_info_command('sample_device_cxx_transaction', get_empty_info)
...
def get_sample_transaction_status(obj):
    return [(None,
             [("value", hex(obj.attr.value))])]
...
cli.new_status_command('sample_device_cxx_attribute_required', get_empty_status)
...
cli.new_status_command('sample_device_cxx_class_with_arg_init_class', get_empty_status)
...
cli.new_status_command('sample_device_cxx_notifier', get_empty_status)
...
cli.new_status_command('sample_device_cxx_transaction', get_sample_transaction_status)
