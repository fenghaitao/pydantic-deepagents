...
# This device is so simple that nothing can be tested
dut10 = SIM_create_object('sample_device_cxx_attribute_required', 'dut10',
                          [["num_channels", 4]])
stest.expect_equal(dut10.num_channels, 4)
