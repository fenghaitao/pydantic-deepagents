...
//:: pre SampleClassWithArg/definition {{
class SampleClassWithArg : public simics::ConfObject {
  public:
    explicit SampleClassWithArg(const simics::ConfObjectRef &obj,
                                int number)
        : ConfObject(obj), number_(number) {}
...
extern "C" void init_local() {
    ...
    simics::make_class<SampleClassWithArg, int>(
        // Simics class name
        "sample_device_cxx_class_with_arg_init_class",
        // short description
        "sample C++ class device with arg & init_class",
        // class documentation
        "This is a sample Simics device written in C++.",
        // extra argument for SampleClassWithArg
        0x1234);
}
// }}
